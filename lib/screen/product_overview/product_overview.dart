...
import 'package:ecommerce_app/widgets/count.dart';
            ...
            child: Container(
              ...
              child: ListView(
                children: [
                  ...
                  Text(
                    "of a customer. Wikipedia In marketing, a product is an object or system made available for consumer use; it is anything that can be offered to a market to satisfy the desire or need of a customer. Wikipedia",
                    style: TextStyle(
                      fontSize: 16,
                      color: textColor,
                    ),
